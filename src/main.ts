 ...
 * Made by 7etsukae.Hope you can learn something from this project. If you have any questions, feel free to ask me issues section. I will try to answer your questions as soon as possible. Thank you for your support and interest in this project.
 *
 ...
 * If you fork this project just credit me for the desing/CSS if you don't change it. No need to credit me on the backend side. */
...
const folderListContainer = getRequiredElement<HTMLUListElement>('todo-folders')
...
const errorCategory = getRequiredElement<HTMLParagraphElement>('error-category')
...
const renderTodoAssignmentOptions = () => {
  ...
  const folderGroup = groups[1]

  if (!categoryGroup || !folderGroup) return
...
// const to if it should be invisible or not when the Type's Select.
